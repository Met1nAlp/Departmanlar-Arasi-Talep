...
export default function DepartmanYetkilisiNavigator() {
  return (
    ...
    >
      ...
      <Stack.Screen name="RequestDetail" component={RequestDetailScreen} options={{ headerShown: false }} /><Stack.Screen name="RejectRequest" component={RejectRequestScreen} options={{ headerShown: false }} />
